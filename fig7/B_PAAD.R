...
names(which(table(c(veen_positive,veen_DEG))==2))
#M2
# "CCL13"  "CCL18"  "NT5E"   "TNFSF4"

#Tfh
#"CCL19"   "CD27"    "CXCL13"  "HLA-DOB" "LTA"     "PDCD1"  

names(which(table(c(veen_negative,veen_DEG))==2))
#CD8
# "NT5E"  "VEGFA"
...
#NK
#"CCL13"    "CCR2"     "CXCL12"   "HLA-DOA"  "HLA-DPB1" "SLAMF7"   "TGFB1"    "TNFSF13"  "TNFSF4"  
