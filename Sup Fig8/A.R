setwd("D:/R/Hot_tumor_and_cold_tumor/组织芯片2/exp")
...
pdf(paste("cell.pdf",sep=''),width = 50/2,height = 10*length(out_put_list1)/10)

eval(parse(text = paste('print(cowplot::plot_grid(',paste(out_put_list1, collapse = ","),', ncol=5))',sep='')))
...
pdf(paste("cell2.pdf",sep=''),width = 50/2,height = 10*length(out_put_list2)/10)

eval(parse(text = paste('print(cowplot::plot_grid(',paste(out_put_list2, collapse = ","),', ncol=5))',sep='')))
#eval(parse(text = paste('print(cowplot::plot_grid(',paste(out_put_list, collapse = ","),', ncol=4,labels=out_put_list,label_size=40))',sep='')))
