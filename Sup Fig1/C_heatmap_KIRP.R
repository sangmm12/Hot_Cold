...
ALL1=list(dataAge,dataGender,dataM,dataN,dataStage,dataT,cluster)
#dataGrade,
...
ann_colors = list(
  ...
  T = c(T1 = "#82B7FF", T2 = "#FF81D4",T3 = "#00C6FF",T4 = "#FFD700"),
...
# library(pheatmap)
# library(limma)
# pdf(paste(cancer,"/heatmap_",cancer,"_hc_colun.pdf",sep=''),width = 10,height = 8)
# pheatmap(t(RNA_data1),
#          annotation_col=annotation_col,annotation_colors = ann_colors,
#          cluster_row=F,show_colnames = F,
#          cluster_col=F,scale = "column")
# 
# dev.off()     
# 
# 
