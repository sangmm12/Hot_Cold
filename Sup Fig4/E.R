...
setwd("D:/R/Hot_tumor_and_cold_tumor/GSVA/KEGG/SKCM")
...
library(data.table)
data <- read.table("D:/R/Hot_tumor_and_cold_tumor/Immunecells/CIBERSORT/OVER100/limma/SKCM/convert_exp.txt",row.names = 1)
colnames(data) <- data[1,]
data <- data[-1,]



cluster <- read.csv("D:/R/Hot_tumor_and_cold_tumor/Immunecells/CIBERSORT/OVER100/SKCM/SKCM_clusterresult/SKCM_cluster_hc.csv",header = F)
