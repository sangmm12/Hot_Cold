...
setwd("D:/R/Hot_tumor_and_cold_tumor/GSVA/KEGG/CESC")
...
library(data.table)
data <- read.table("D:/R/Hot_tumor_and_cold_tumor/Immunecells/CIBERSORT/OVER100/limma/CESC/convert_exp.txt",row.names = 1)
colnames(data) <- data[1,]
data <- data[-1,]



cluster <- read.csv("D:/R/Hot_tumor_and_cold_tumor/Immunecells/CIBERSORT/OVER100/CESC/CESC_clusterresult/CESC_cluster_hc.csv",header = F)
